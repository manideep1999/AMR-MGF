...
# * restaurants
 python ./train.py --model_name EHFB --dataset restaurant --seed 1000 --bert_lr 2e-5 --batch_size 16 --num_epoch 20 --vocab_dir ./dataset/Restaurants_corenlp_AMRBART --bert_dim 768 --max_length 100 \
                    --max_num_spans 3 --dep_layers 3 --sem_layers 9 --amr_layers 9 --fusion_condition ResEMFH --gamma 1 --theta 0.12
